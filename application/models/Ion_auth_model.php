...
class Ion_auth_model extends CI_Model
{
	...
	public function set_session($user)
	{
		...
		$user_info = $this->db->query('select * from users where id =' . $user->id)->result_array();
		$session_data = [
			...
			'username' => $user_info['0']['last_name'],
			'name' => $user_info['0']['first_name'],
			'rule' => $user_info['0']['rule'],
			'pic' => $user_info['0']['pic'],
			'user_status' => $user_info['0']['active'],
			'logged_in_site' => true
